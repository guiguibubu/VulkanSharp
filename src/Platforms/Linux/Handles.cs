...
namespace Vulkan.Linux
{
	public static class InstanceExtension
	{
		public static SurfaceKhr CreateMirSurfaceKHR (this Instance instance, MirSurfaceCreateInfoKhr pCreateInfo, AllocationCallbacks pAllocator = null)
		{
			...
			unsafe {
				...
				fixed (UInt64* ptrpSurface = &pSurface.m) {
					result = Linux.Interop.NativeMethods.vkCreateMirSurfaceKHR (instance.m, pCreateInfo != null ? pCreateInfo.m : (Linux.Interop.MirSurfaceCreateInfoKhr*)default(IntPtr), pAllocator != null ? pAllocator.m : null, ptrpSurface);
				}
		...
		public static SurfaceKhr CreateWaylandSurfaceKHR (this Instance instance, WaylandSurfaceCreateInfoKhr pCreateInfo, AllocationCallbacks pAllocator = null)
		{
			...
			unsafe {
				...
				fixed (UInt64* ptrpSurface = &pSurface.m) {
					result = Linux.Interop.NativeMethods.vkCreateWaylandSurfaceKHR (instance.m, pCreateInfo != null ? pCreateInfo.m : (Linux.Interop.WaylandSurfaceCreateInfoKhr*)default(IntPtr), pAllocator != null ? pAllocator.m : null, ptrpSurface);
				}
				if (result != Result.Success)
					throw new ResultException (result);
		...
		public static SurfaceKhr CreateXlibSurfaceKHR (this Instance instance, XlibSurfaceCreateInfoKhr pCreateInfo, AllocationCallbacks pAllocator = null)
		{
			...
			unsafe {
				...
				fixed (UInt64* ptrpSurface = &pSurface.m) {
					result = Linux.Interop.NativeMethods.vkCreateXlibSurfaceKHR (instance.m, pCreateInfo != null ? pCreateInfo.m : (Linux.Interop.XlibSurfaceCreateInfoKhr*)default(IntPtr), pAllocator != null ? pAllocator.m : null, ptrpSurface);
				}
				if (result != Result.Success)
					throw new ResultException (result);
		...
		public static SurfaceKhr CreateXcbSurfaceKHR (this Instance instance, XcbSurfaceCreateInfoKhr pCreateInfo, AllocationCallbacks pAllocator = null)
		{
			...
			unsafe {
				...
				fixed (UInt64* ptrpSurface = &pSurface.m) {
					result = Linux.Interop.NativeMethods.vkCreateXcbSurfaceKHR (instance.m, pCreateInfo != null ? pCreateInfo.m : (Linux.Interop.XcbSurfaceCreateInfoKhr*)default(IntPtr), pAllocator != null ? pAllocator.m : null, ptrpSurface);
				}
				if (result != Result.Success)
					throw new ResultException (result);
	...
	public static class PhysicalDeviceExtension
	{
		...
		public static Bool32 GetXlibPresentationSupportKHR (this PhysicalDevice physicalDevice, UInt32 queueFamilyIndex, out IntPtr dpy, VisualID visualID)
		{
			unsafe {
		...
		public static Bool32 GetXcbPresentationSupportKHR (this PhysicalDevice physicalDevice, UInt32 queueFamilyIndex, out IntPtr connection, Int32 visual_id)
		{
			unsafe {
