...
namespace Vulkan.Linux.Interop
{
	internal static class NativeMethods
	{
		...
		[DllImport (VulkanLibrary, CallingConvention = CallingConvention.Winapi)]
		internal static unsafe extern Bool32 vkGetPhysicalDeviceXlibPresentationSupportKHR (IntPtr physicalDevice, UInt32 queueFamilyIndex, IntPtr* dpy, VisualID visualID);
